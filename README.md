...
## 자기소개.
- **앱 서비스를 개발/배포/운영하였으며, 주로 앱 서비스 개발을 담당**했습니다.
22.05 ~ 23.04까지 iOS 개발자로 스타트업에서 iOS 개발자로 재직했었습니다.

- **시리즈A 에서 시리즈B 과정을 함께 겪었습니다**
소규모의 개발팀에 iOS 개발자로 입사했었습니다.

- **19명 규모의 서비스 본부로 상장할 때까지 함께 성장했던 경험이 있습니다.**
...
- **팀이 가지고 있는 힘은 협업에서 나온다고 생각합니다.**
구성원들과 적극적으로 **커뮤니케이션하며 유연한 소통으로 협업**해왔습니다.


- **이유있는 코드를 만들고 비효율적인 프로세스를 개선하는 일을 좋아합니다.**
무작정 동작하는 코드보다 **이유가 있는 코드**를 만들어 왜 코드를 이런 형태로 구현했는지 설명하고
반복적인 코드를 모듈화하여 **가독성 있는 코드**로 **개선하고 개발한 경험**이 있습니다.
